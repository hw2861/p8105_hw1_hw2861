...
```
    ...
    ##         x1 x2    x3    x4    
    ##      <dbl> <lgl> <chr> <fct> 
    ##  1  0.411  TRUE  a     Small 
    ##  2  0.270  TRUE  b     Medium
    ##  3 -0.882  FALSE c     Small 
    ##  4 -0.272  FALSE d     Small 
    ##  5 -1.22   FALSE e     Large 
    ##  6 -2.60   FALSE f     Large 
    ##  7 -1.18   FALSE g     Medium
    ##  8 -0.407  FALSE h     Large 
    ##  9  0.591  TRUE  i     Medium
    ## 10  0.0624 TRUE  k     Small
