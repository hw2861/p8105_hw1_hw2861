...
We learned that there are three species of penguins (Adelie,Chinstrap and Gentoo) in the dataset from the three islands(Biscoe,Dream and Torgersen).We can also know the distribution of bill Depth/Length and flipper length, body mass,the sex and the year of these penguins.
For example,The mean flipper length is `r mean(penguins$flipper_length_mm, na.rm = TRUE)`mm. 
