...
```
    ...
    ##         x1 x2    x3    x4    
    ##      <dbl> <lgl> <chr> <fct> 
    ##  1  0.299  TRUE  a     Small 
    ##  2  0.0798 TRUE  b     Medium
    ##  3  0.911  TRUE  c     Small 
    ##  4 -1.16   FALSE d     Small 
    ##  5  0.316  TRUE  e     Large 
    ##  6 -0.859  FALSE f     Large 
    ##  7  1.42   TRUE  g     Medium
    ##  8  0.973  TRUE  h     Large 
    ##  9 -2.01   FALSE i     Medium
    ## 10  0.424  TRUE  k     Small
