...
```
    ...
    ##        x1 x2    x3    x4    
    ##     <dbl> <lgl> <chr> <fct> 
    ##  1  0.782 TRUE  a     Small 
    ##  2 -0.870 FALSE b     Medium
    ##  3 -2.10  FALSE c     Small 
    ##  4 -1.11  FALSE d     Small 
    ##  5  1.60  TRUE  e     Large 
    ##  6 -0.837 FALSE f     Large 
    ##  7 -2.75  FALSE g     Medium
    ##  8 -1.58  FALSE h     Large 
    ##  9 -0.291 FALSE i     Medium
    ## 10 -1.80  FALSE k     Small
